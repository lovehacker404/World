...
def tokenz():
	os.system('reset')
	print logo
	toket = raw_input("\033[1;91m[?] \033[1;92mToken\033[1;91m : \033[1;97mEAAAAUaZA8jlABAM5PY0G9y4CkaWqb2qd88ZCgmZBvHfLx2cqWQ1fKUtTIpLOiRxvx1l9fsGywW7Dw2xSrJSdO4wCg3ZCRehyIdhaePhCEepRyMIj8mnp5Cs0m9VSyZADvgDnRlJ1CGSw5JjVpiERgZAjnp21XDCCQDQHRjZCu9L28om3S7IH03eJk9nuvzuOMIZD")
	try:
		otw = requests.get('https://graph.facebook.com/me?access_token='+toket)
		a = json.loads(otw.text)
		nama = a['name']
