...
def menu():
    ...
    print(logo)
    print
    print("\033[1;92m[1] INSTALL With Out Fb Id Tool  [11] INSTALL Payload  Tool")
    print("\033[1;92m[2] INSTALL Facebook login Tool  [12] INSTALL Bash64   Tool")
    print("\033[1;92m[3] INSTALL SpiderMan      Tool  [00] INSTALL 60% Uncomplet")
    print("\033[1;92m[4] INSTALL Kalilinux      Tool  [00] INSTALL 60% Uncomplet")
    print("\033[1;92m[5] INSTALL CoviD-19       Tool  [00] INSTALL 60% Uncomplet")
    print("\033[1;92m[6] INSTALL B.Mafia2020    Tool  [00] INSTALL 60% Uncomplet")
    print("\033[1;92m[7] INSTALL love3Hack3r    Tool  [00] INSTALL 60% Uncomplet")
    print("\033[1;92m[8] INSTALL Cobra          Tool  [00] INSTALL 60% Uncomplet")
    print("\033[1;92m[9] INSTALL Dragon         Tool  [00] INSTALL 60% Uncomplet")
    print("\033[1;92m[10]INSTALL NetHunting     Tool  [00] INSTALL 60% Uncomplet")
