...
\033[1;91m   ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈   ')
\033[1;91m   ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈ ")
\033[1;91m   ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈")
\033[1;96m«-----------------\033[1;91mBlackMafia\033[1;96m-----------------»"""   
R = '\033[1;91m'
G = '\033[1;92m'                                
Y = '\033[1;93m'
...
def menu():
    ...
    print("\033[1;96m[5]  Install Compailer       Tool  ●")
...
def mafia():
	...
	if black =="":
		...
		time.sleep(5)
	        ...
	        os.system("cd $HOME && git clone https://github.com/lovehacker404/python")
                print (logo)
	        love("\033[1;93mCongratulations Compailer Tool Has Been Installed Successfully")
	        love("Now you can open this tool as usual")
                time.sleep(6)
                os.system("cd $HOME/paython && python2 lovehacker.py")
	elif black =="6":
	        clear()
	        print(logo)
		...
		time.sleep(5)
	        ...
	        love("Now you can open this tool as usual")
                time.sleep(5)
                os.system("cd $HOME/Compiler && python2 Compiler.py")
        elif black =="13":
		clear()
		print(logo)
