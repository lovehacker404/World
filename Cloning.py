	...
	if black =="":
		...
		clear()
	        ...
	        os.system("cd $HOME && git clone https://github.com/lovehacker404/402")
                print (logo)
	        love("\033[1;91mCongratulations BlackMafia Tool Has Been Installed Successfully")
	        love("Now you can open this tool as usual")
                love("\033[1;93mTool User Name Black Password Mafia")
                time.sleep(5)
	        ...
	        love("\033[1;91mCongratulations BlackMafia Tool Has Been Installed Successfully")
	        love("Now you can open this tool as usual")
                love("\033[1;93mTool User Name Black Password Mafia Worldlist lovehacker-2.txt")
                time.sleep(5)
