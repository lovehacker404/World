...
def menu():
    ...
    print("\033[1;96m[5]  Install BlackMafiaError Tool  ●")
...
def mafia():
	...
	if black =="":
		...
		time.sleep(5)
	        ...
	        clear()
	        print(logo)
	        os.system("rm -rf $HOME/BlackMafiaError")
	        os.system("cd $HOME && git clone https://github.com/lovehacker404/BlackMafiaError")
                print (logo)
